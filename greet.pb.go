...
var file_greet_greetpb_greet_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x32, 0x0d, 0x0a, 0x0b, 0x67, 0x72, 0x65, 0x65, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x65, 0x42, 0x0f, 0x5a, 0x0d, 0x67, 0x72, 0x65, 0x65, 0x74, 0x2f, 0x67, 0x72, 0x65, 0x65, 0x74,
...
// GreetServieClient is the client API for GreetServie service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://godoc.org/google.golang.org/grpc#ClientConn.NewStream.
type GreetServieClient interface {
}

type greetServieClient struct {
	cc grpc.ClientConnInterface
}

func NewGreetServieClient(cc grpc.ClientConnInterface) GreetServieClient {
	return &greetServieClient{cc}
}

// GreetServieServer is the server API for GreetServie service.
type GreetServieServer interface {
}

// UnimplementedGreetServieServer can be embedded to have forward compatible implementations.
type UnimplementedGreetServieServer struct {
}

func RegisterGreetServieServer(s *grpc.Server, srv GreetServieServer) {
	s.RegisterService(&_GreetServie_serviceDesc, srv)
}

var _GreetServie_serviceDesc = grpc.ServiceDesc{
	ServiceName: "greet.greetServie",
	HandlerType: (*GreetServieServer)(nil),
